...
<table border="1" align="center" width="100%">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_index['no_hp']; ?>&nbsp; </td>
      <td><?php echo $row_index['alamat']; ?>&nbsp; </td>
      <td><a href="edit.php?id_user=<?php echo $row_index['id_user']; ?>">Edit</a> | <a href="hapus.php?id_user=<?php echo $row_index['id_user']; ?>">Hapus</a></td>
    </tr>
