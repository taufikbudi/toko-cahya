...
<table border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      <td><a href="detail.php?recordID=<?php echo $row_index['id_halaman']; ?>"> <?php echo $row_index['id_halaman']; ?>&nbsp; </a></td>
      <td><?php echo $row_index['judul_halaman']; ?>&nbsp; </td>
      <td><?php echo $row_index['isi_halaman']; ?>&nbsp; </td>
      <td><a href="edit.php?id_halaman=<?php echo $row_index['id_halaman']; ?>">Edit</a> | <a href="hapus.php?id_halaman=<?php echo $row_index['id_halaman']; ?>">Hapus</a></td>
    </tr>
