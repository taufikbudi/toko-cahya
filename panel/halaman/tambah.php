...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO halaman (judul_halaman, isi_halaman) VALUES (%s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="judul_halaman" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Isi_halaman:</td>
      <td><textarea name="isi_halaman" cols="50" rows="5"></textarea></td>
    </tr>
    <tr valign="baseline">
