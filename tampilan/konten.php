...
$query_tampil_konten = "SELECT * FROM list_barang,kategori_barang WHERE list_barang.id_kategori=kategori_barang.id_kategori";
...
<div class="produk">
    ...
    <p> Kategori : <a href="kategori.php?id_kategori=<?php echo $row_tampil_konten['id_kategori']; ?>"><?php echo $row_tampil_konten['nama_kategori']; ?></a>&nbsp;  </p>
...
<strong>Stok : <?php echo $row_tampil_konten['stok']; ?> Unit
    ...
    <li class="harga"> Harga : Rp.<?php echo format_rupiah($row_tampil_konten['harga_barang']); ?>,- </li>
